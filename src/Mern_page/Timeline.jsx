                        ...
                        <div className='grid grid-cols-[1fr_auto_1fr] mx-auto items-center gap-x-3 '>
                            {
                                event.direction === 'left' ? ( 
                                    <Featurecard heading={event.heading} subheading={event.subheading}/>
                                 ) : (
                                    <div></div>
                                 )
                            }
...
const Circle = ()=>{
    return(
        <div className="rounded-full bg-gradient-to-r from-sky-950 to-cyan-400 w-5 h-5 mx-auto bg-blue-500">
...
const Pillar = ()=>{
    return(
        <div className="rounded-t-full bg-gradient-to-r from-neutral-900 to-cyan-400 rounded-b-full w-2 h-full mx-auto bg-blue-500">
